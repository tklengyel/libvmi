...
status_t process_vmexit(vmi_instance_t vmi, vm_event_compat_t *vmec)
{
    ...
    event->vmexit_event.reason = vmec->vmexit.reason;
    event->vmexit_event.qualification = vmec->vmexit.qualification;
    event->vmexit_event.gpa = vmec->vmexit.u.gpa;
